                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-7">
                      <!-- blockquote -->
                      <blockquote>
                        <p>Selamat Datang di aplikasi Email Security. Aplikasi ini merupakan aplikasi yang digunakan untuk melindungi data pada email. Aplikasi ini dilengkapi sistem enkripsi dan dekripsi data.</p>
                      ...
                      <blockquote class="blockquote-reverse">
                       ...
                       <br>
                       <br>
                        <footer> <cite title="Source Title">By Raodatul Jannah</cite>
                        </footer>
                      </blockquote>
                    </div>
